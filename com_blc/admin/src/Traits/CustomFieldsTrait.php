        ...
        switch ($type) {
            ...
            case 'mediajce':
                ...
                if (\is_string($fieldValue)) {
                    ...
                    $image_alt = ($fieldValue->media_text ?? PARSE_STRINGS::BLC_EMPTY_ALT) ?: PARSE_STRINGS::BLC_EMPTY_ALT;
                }
            ...
            case 'media':
                ...
                if (\is_string($fieldValue)) {
                    ...
                    $image_alt = ($fieldValue->alt_text ?? PARSE_STRINGS::BLC_EMPTY_ALT) ?: PARSE_STRINGS::BLC_EMPTY_ALT;
                }
