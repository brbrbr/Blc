...
CREATE TABLE `#__blc_links` (
  ...
  `last_check` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `first_failure` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  ...
  `last_check_attempt` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `last_success` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
