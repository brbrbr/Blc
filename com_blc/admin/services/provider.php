...
return new class () implements ServiceProviderInterface {
    ...
    public function register(Container $container)
    {
        ...
        $container->registerServiceProvider(new CategoryFactory('\\Blc\\Component\\Blc'));
        $container->registerServiceProvider(new MVCFactory('\\Blc\\Component\\Blc'));
        $container->registerServiceProvider(new ComponentDispatcherFactory('\\Blc\\Component\\Blc'));
        $container->registerServiceProvider(new RouterFactory('\\Blc\\Component\\Blc'));
