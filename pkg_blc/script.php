        ...
        $container->set(
            ...
            new class () implements InstallerScriptInterface {
                ...
                private $oldFiles = [
                    ...
                    //25.44.6807
                    '/administrator/components/com_blc/src/Traits/BlcReplaceAltTrait.php', //renamed during DEV
                    '/administrator/components/com_blc/src/Interface/BlcReplaceAltInterface.php', //renamed during DEV
